...
final d'une équipe de football à partir de statistiques de matchs et d'équipes.
"""
...
from src.fonctions.manipulations import fusionner, id_to_nom
from src.fonctions.statistiques import calculer_classement


def predire_classement_avec_confiance(saison, league_id_cible, team_id_cible):
    """
    Prédit le classement d'une équipe pour une saison donnée à l'aide d'un
    modèle de régression de Poisson, et retourne son rang et un intervalle de
    confiance sur ses points.

    Args:
        saison (str): Saison cible (ex: "2014/2015") league_id_cible (int): ID
        de la ligue team_id_cible (int): ID de l'équipe
