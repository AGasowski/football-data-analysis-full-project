...
meilleurs_buteurs = sorted(meilleurs_buteurs.items(), key=lambda x: x[1], reverse=True)[
    :30
]
...
meilleur_carton_jaune = sorted(carton_jaunes.items(), key=lambda x: x[1], reverse=True)[
    :30
]
