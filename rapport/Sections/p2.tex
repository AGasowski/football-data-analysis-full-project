...
instants. Puis nous calculons la moyenne de ces écarts-types pour chaque
joueur. Nous calculons ensuite la moyenne des écarts-types pour chaque équipe,
en considérant les 11 joueurs jouant le plus. Nous obtenons alors les équipes
dont les joueurs ont des performances plutôt cohérentes dans le temps.
