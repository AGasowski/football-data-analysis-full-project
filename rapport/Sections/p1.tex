...
données sur le football européen, allant de 2008 à 2016. Les différentes tables
qui la compose sont: 
\begin{itemize}
    \item \textbf{Country} : Table de référence listant les pays. Elle associe
    un identifiant à un nom de pays.
    ...
    etc.). Ici, nous ne représentons que la table Goal, mais il en existe plein
    d'autres de même nature telles que Shoton, Shotoff, Foulcommit, Card,
    Cross, Corner ou Possession.
\end{itemize}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth, keepaspectratio]{Images/schema_relationnel2.png}
    \begin{centering}
