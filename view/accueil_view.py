...
from src.fonctions.save import capture_et_enregistrer_png
...
class AccueilView(AbstractView):
    ...
    def make_choice(self):
        ...
        if (
            ...
            from src.Q2_diff_buts_max import run_q2
            ...
            if saison == "Toutes les saisons réunies":
                saison = "0"
            from src.Q3_taille_moyenne import run_q3
            ...
            from view.q4_view import Q4View
            ...
            if saison == "Toutes les saisons réunies":
                saison = "0"
            from src.Q5_meilleur_formation import run_q5
            ...
            if saison == "Toutes les saisons réunies":
                saison = "0"
            from src.Q6_jour_matchs_nuls import run_q6
            ...
            from view.q7_view import Q7View
            ...
            from src.q8_variance_11 import run_q8
            ...
            if saison == "Toutes les saisons réunies":
                saison = "0"
            champ = prompt(self.question_championnat)["question championnat"]
            from src.Q9_equipe_but_exterieur import run_q9
            ...
            from src.q10_aptitudes_age import run_q10
            ...
            if saison == "Toutes les saisons réunies":
                saison = "0"
            champ = prompt(self.question_championnat)["question championnat"]
            from src.Q11_pire_ratio_tirs import run_q11
            ...
            if saison == "Toutes les saisons réunies":
                saison = "0"
            from src.q12_imprevisible import run_q12
            ...
            from view.apprentissage_view import AppView
